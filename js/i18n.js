...
const I18N = {
  hu: {
    ...
    "hero.desc": "**IT Support** pozíciót keresek: **felhasználói kérések** kezelése, **Windows végpontok beállítása**, **hibák elhárítása**, **ticket alapú támogatás**. Emellett **Cisco routing/switching** laborokból is van gyakorlatom.",
  ...
  en: {
    ...
    "hero.desc": "I’m looking for an **IT Support** role: handling **user requests**, **Windows endpoint setup**, **incident troubleshooting**, and **ticket-based support**. I also have hands-on practice from **Cisco routing/switching** labs.",
